...
# Shared .env.local helpers live in agent_scaffold.envfile so the pre-flight
# gate in cmd_new can check presence without importing the orchestrator chain.
# Module-level aliases keep this step's call sites + existing tests unchanged.
