...
ALIAS_TABLE: dict[str, str] = {
    ...
    "qdrant": "stack/qdrant.md",
    "postgres": "stack/postgres.md",
    "redis": "stack/redis.md",
    "langfuse": "stack/langfuse.md",
    "fastapi": "stack/fastapi.md",
    "hono": "stack/hono.md",
    "anthropic": "stack/anthropic.md",
    "claude": "stack/anthropic.md",
}
...
CROSS_CUTTING: dict[str, str] = {
    "auth": "cross-cutting/auth.md",
    "logging": "cross-cutting/logging.md",
